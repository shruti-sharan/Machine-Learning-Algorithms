...
def train(data, file_name, params, num_epochs=2, batch_size=128, train_temp=1, init=None):
    """
...
def train_distillation(data, file_name, params, num_epochs=2, batch_size=128, train_temp=1):
    """
